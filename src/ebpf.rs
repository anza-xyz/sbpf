...
/// BPF opcode: `call64 imm` /// syscall or function call to syscall with key `imm`.
pub const CALL_IMM: u8 = BPF_JMP64 | BPF_CALL;
/// BPF opcode: `call64 reg`
pub const CALL_REG: u8 = BPF_JMP64 | BPF_X | BPF_CALL;
/// BPF opcode: `exit64` /// `return r0`. /// Valid only until SBPFv3
pub const EXIT: u8 = BPF_JMP64 | BPF_EXIT;
/// BPF opcode: `return` /// `return r0`. /// Valid only since SBPFv3
pub const RETURN: u8 = BPF_JMP64 | BPF_X | BPF_EXIT;
/// BPF opcode: `syscall` /// `syscall imm`. /// Valid only since SBPFv3
pub const SYSCALL: u8 = BPF_JMP64 | BPF_SYSCALL;
